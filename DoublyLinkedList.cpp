...
/**
 * @brief Swaps the items at the given positions
 * 
 * @tparam T 
 * @param pos1 
 * @param pos2 
 */
template <class T>
void DoublyLinkedList<T>::swap(int  pos1, int pos2){
  Node<T> *node1 = getPointerTo(pos1);
  Node<T> *node2 = getPointerTo(pos2);
